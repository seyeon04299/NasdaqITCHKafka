...
session_cfg = {
    ...
    "topic": "TOTALVIEW",
    "symbols": "SPY",
    "authprops": "/home/namhooncho/NasdaqCloudDataService-SDK-Python/client-authentication-config.json",
    "kafkaprops": "/home/namhooncho/NasdaqCloudDataService-SDK-Python/kafka-config.json",
...
ncds_session = NCDSSession(session_cfg)
